 ...
 */
export var QuantumDerivationPath;
...
})(QuantumDerivationPath || (QuantumDerivationPath = {}));
/**
 ...
 */
export function getQuantumPath(account = 0, addressIndex = 0, isChange = false) {
 ...
 * @returns BIP32 derivation path string
 */
export function getBitcoinPath(bipType, account = 0, addressIndex = 0, isChange = false) {
    const changeIndex = isChange ? 1 : 0;
