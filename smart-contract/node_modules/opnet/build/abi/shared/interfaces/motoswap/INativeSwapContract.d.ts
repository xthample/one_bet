...
export interface INativeSwapContract extends IOP_NETContract {
    ...
    createPool(token: Address, floorPrice: bigint, initialLiquidity: bigint, receiver: Buffer, receiverStr: string, antiBotEnabledFor: number, antiBotMaximumTokensPerReservation: bigint, maxReservesIn5BlocksPercent: number, poolType: number, amplification: bigint, pegStalenessThreshold: bigint): Promise<CreatePool>;
